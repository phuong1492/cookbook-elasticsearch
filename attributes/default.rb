...
# }
default['elasticsearch']['download_urls'] = {
  'debian' => 'https://download.elastic.co/elasticsearch/release/org/elasticsearch/distribution/tar/elasticsearch/2.3.2/elasticsearch-%s.deb',
  'rhel' => 'https://download.elastic.co/elasticsearch/release/org/elasticsearch/distribution/tar/elasticsearch/2.3.2/elasticsearch-%s.rpm',
  'tarball' => 'https://download.elastic.co/elasticsearch/release/org/elasticsearch/distribution/tar/elasticsearch/2.3.2/elasticsearch-%s.tar.gz'
}
...
default['elasticsearch']['checksums']['2.3.2']['tarball'] = '04c4d3913d496d217e038da88df939108369ae2e78eea29cb1adf1c4ab3a000a'
